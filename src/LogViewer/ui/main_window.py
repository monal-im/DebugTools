...
class MainWindow(QtWidgets.QMainWindow):
    ...
    def toggleUiItems(self):
        ...
        self.uiAction_listenUdpStream.setEnabled(self.file == None and (self.udpServer == None or not self.udpServer.isRunning()))
        self.uiAction_stopUdpStream.setEnabled(self.udpServer != None and self.udpServer.isRunning())
