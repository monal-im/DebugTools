...
# parse commandline
parser = argparse.ArgumentParser(formatter_class=argparse.RawTextHelpFormatter, description="Monal Mobile Log Viewer")
...
from MobileLogViewer.ui import MainWindow
